...
!function( $ ){
  ...
  * ========================= */
  ...
  $(function () {
    $('html').on('mouseenter.dropdown.data-api', clearMenus)
        ...
        start: function() {
            ...
            if(!$("#spinner").length) {
                ...
                $(document).scroll(function() {
                     var tp = ($(window).height() * .3) + $(document).scrollTop();
                    $("#spinner .spinner").stop(true).animate({ top: tp },500);
                });
            }
